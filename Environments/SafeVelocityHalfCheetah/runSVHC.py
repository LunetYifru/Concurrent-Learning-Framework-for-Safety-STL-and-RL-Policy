...
df_x1, df_v1 = organize_rollout('/home/WVU-AD/lay0005/Downloads/JLF_SPG1_Final/states_SHCV1_100ep_BL1.pkl')
df_x2, df_v2 = organize_rollout('/home/WVU-AD/lay0005/Downloads/JLF_SPG1_Final/states_SHCV1_100ep_BL2.pkl')
df_x2, df_v2 = organize_rollout('/home/WVU-AD/lay0005/Downloads/JLF_SPG1_Final/states_SHCV1_300ep_BL2.pkl')
df_p_x = pd.concat([df_x1, df_x2], axis=1, ignore_index=True)
df_v_x = pd.concat([df_v1, df_v2], axis=1, ignore_index=True)
